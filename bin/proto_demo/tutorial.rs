...
// @@protoc_insertion_point(message:tutorial.Student)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Student {
    // message fields
    // @@protoc_insertion_point(field:tutorial.Student.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:tutorial.Student.id)
    pub id: i32,
    // @@protoc_insertion_point(field:tutorial.Student.age)
    pub age: i32,
    // special fields
    // @@protoc_insertion_point(special_field:tutorial.Student.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a Student {
    fn default() -> &'a Student {
        <Student as ::protobuf::Message>::default_instance()
    }
}
...
impl Student {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "name",
            |m: &Student| { &m.name },
            |m: &mut Student| { &mut m.name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &Student| { &m.id },
            |m: &mut Student| { &mut m.id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "age",
            |m: &Student| { &m.age },
            |m: &mut Student| { &mut m.age },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<Student>(
            "Student",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for Student {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.age != 0 {
            my_size += ::protobuf::rt::int32_size(3, self.age);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn default_instance() -> &'static Student {
        static instance: Student = Student {
            name: ::std::string::String::new(),
            id: 0,
            age: 0,
            special_fields: ::protobuf::SpecialFields::new(),
...
impl ::protobuf::MessageFull for Student {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("Student").unwrap()).clone()
    }
}
...
impl ::protobuf::reflect::ProtobufValue for Student {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0etutorial.proto\x12\x08tutorial\"B\n\x06Person\x12\x12\n\x04name\
    ...
    \x05R\x02id\x12\x10\n\x03age\x18\x03\x20\x01(\x05R\x03ageb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(Student::generated_message_descriptor_data());
